...
namespace MajabajaGame
{
    ...
    class Level5State : AbstractGameState
    {
        // Music
        ...
        TileMap level5Background;
        TileMap level5Decoration;
        TileMap level5Obstacle;
        int squaresAcross = 8;
        int squaresDown = 4;
        int DecoAcross = 16;
        int DecoDown = 8;
        ...
        public Level5State(Game1 p_game)
            : base(p_game)
        {
            resetLevel();
            LoadContent();
        ...
        public override void LoadContent()
        {
            ...
            // Load Tiles
            using (var stream = TitleContainer.OpenStream("level5.txt"))
            {
                using (var reader = new StreamReader(stream))
                {
                    ...
                    level5Background = new TileMap(length, height);
                    ...
                    {          
                        for (int i = 0; i < height; ++i)
                        {
                            ...
                            {
                                level5Background.Rows[i].Columns[j].TileID = Convert.ToInt16(buffer[j])-48;
                            }
                        }
            ...
            using (var stream = TitleContainer.OpenStream("level5decoration.txt"))
            {
                using (var reader = new StreamReader(stream))
                {
                    int length = Convert.ToInt16(reader.ReadLine());
                    ...
                    level5Decoration = new TileMap(length, height);
                    ...
                    while (!reader.EndOfStream)
                    {
                        for (int i = 0; i < height; ++i)
                        {
                            ...
                            for (int j = 0; j < length; ++j)
                            {
                                level5Decoration.Rows[i].Columns[j].TileID = Convert.ToInt16(buffer[j]);
                            }
                        }
            ...
            using (var stream = TitleContainer.OpenStream("level5obstacle.txt"))
            {
                using (var reader = new StreamReader(stream))
                {
                    int length = Convert.ToInt16(reader.ReadLine());
                    ...
                    level5Obstacle = new TileMap(length, height);
                    ...
                    while (!reader.EndOfStream)
                    {
                        for (int i = 0; i < height; ++i)
                        {
                            ...
                            for (int j = 0; j < length; ++j)
                            {
                                level5Obstacle.Rows[i].Columns[j].TileID = Convert.ToInt16(buffer[j]);
                            }
                        }
            ...
            Character.levelObstacle = level5Obstacle;
            ...
            Camera.Location.Y = ((level5Background.MapHeight) * 128) - 480;
        }
                ...
                for (int y = 0; y < squaresDown; y++)
                {
                    for (int x = 0; x < squaresAcross; x++)
                    {
                        m_spriteBatch.Draw(
                            ...
                            BackgroundTile.GetSourceRectangle(level5Background.Rows[y + firstY].Columns[x + firstX].TileID),
                            Color.White);
                    }
                }
            m_spriteBatch.End();
            ...
            m_spriteBatch.Begin();
                ...
                for (int y = 0; y < DecoDown; y++)
                {
                    for (int x = 0; x < DecoAcross; x++)
                    {
                        ...
                        if (level5Decoration.Rows[y + firstY1].Columns[x + firstX1].TileID >= 48 && level5Decoration.Rows[y + firstY1].Columns[x + firstX1].TileID < 58)
                        {
                            tempValue = level5Decoration.Rows[y + firstY1].Columns[x + firstX1].TileID - 48;
                        }
                        else
                        {
                            tempValue = level5Decoration.Rows[y + firstY1].Columns[x + firstX1].TileID - 55;
                        }
            ...
            m_spriteBatch.Begin();
                ...
                for (int y = 0; y < ObstDown; y++)
                {
                    for (int x = 0; x < ObstAcross; x++)
                    {
                        ...
                        if (level5Obstacle.Rows[y + firstY2].Columns[x + firstX2].TileID >= 48 && level5Obstacle.Rows[y + firstY2].Columns[x + firstX2].TileID < 58)
                        {
                            tempValue1 = level5Obstacle.Rows[y + firstY2].Columns[x + firstX2].TileID - 48;
                        }
                        else
                        {
                            tempValue1 = level5Obstacle.Rows[y + firstY2].Columns[x + firstX2].TileID - 55;
                        }
        ...
        public override void Update(Microsoft.Xna.Framework.GameTime gameTime)
        {
            ...
            Camera.Location.X = MathHelper.Clamp(Camera.Location.X + 6, 0, (level5Background.MapWidth - squaresAcross) * 128);
